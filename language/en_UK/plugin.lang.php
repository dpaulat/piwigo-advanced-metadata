...
$lang['g003_help_exif'] = 'EXIF Metadata is information stored in the image file by the camera at shooting. <br>The information there are mainly technical:[ul][li]equipment used (camera model, maker)[/li][li]shooting conditions (aperture, exposure time, focal length)[/li][li]time of the shooting (date, time)[/li][li]geographic location (GPS coordinates)[/li][li]information on the photo format (size, resolution, compression)[/li][/ul]EXIF metadata is standardized ([url]http://www.exif.org/Exif2-2.PDF[/url]), but: [ul][li]This standard established by the [url=http://www.jeita.or.jp]JEITA[/url] (Japan Electronics and Information Technology Industries Association) has no longer changed since 2002[/li][li]each metadata defined in the standard is optional, so not all cameras feed all metadata[/li][li]a [i]MakerNote[/i] metadata exists as an open field used by manufacturers to store information missing from the specifications (eg, lenses references); this data are specific to each manufacturer, sometimes for each camera. The plugin knows how to render some of this information for [b]Pentax[/b], [b]Canon[/b] and [b] Nikon [/b] cameras.[/li][/ul]';
$lang['g003_help_iptc'] = 'IPTC Metadata consists of information the photographer can record in the image with an appropriate software. <br> Information there is mainly oriented towards the professional world: [ul] [li]photographer references (name, contact)[/li] [li]information on the Copyright[/li] [li]description of the picture (title, description, reviews, tags)[/li] [li]various information related to the professional world[/li] [/ul] IPTC metadata is standardized ([url]http://www.iptc.org[/url]). This standard has been established by a consortium of major news agencies in the world, the [i]International Press Telecommunications Council [/i] (IPTC). [li] information on the format of the photo (size, resolution, compression)';
$lang['g003_help_xmp'] = 'XMP metadata are essentially EXIF and IPTC metadata that have been stored in the image file using XML format. <br> XMP metadata provide more flexibility: [ul] [li]information can be stored in several different languages[/li] [li]usage of the Unicode character set allows (mainly) to use non-Latin characters[/li] [li]XML facilitates the interpretation and exchange of information[/li] [/ul] XMP metadata is standardized ([url]http://www.metadataworkinggroup.org/specs[/url]). The standard advises to use preferably the EXIF and IPTC metadata, if present. EXIF & IPTC metadata conversion to XMP metadata is usually done with a photo editing software. As XMP model is poorer than EXIF, this conversion will result in information loss in the picture. Usually the lost information is not too important for most users; however, the standard recommends that the software recording XMP metadata retain the original metadata: unfortunately, that is not always the case.';
$lang['g003_help_magic'] = 'The same information can be stored within a photo in multiple formats: [ul] [li]it may exist in every format[/li] [li]it may be present in one format but not in another one[/li] [/ul] For example, the aperture may be present in 4 different metadata: [ul] [li][b]exif.exif.FNumber[/b][/li] [li][b]exif.exif.ApertureValue[/b][/li] [li][b]xmp.exif:ApertureValue[/b][/li] [li][b]xmp.exif:FNumber[/b][/li] [/ul] To facilitate the rendering of information that may be scattered, the plugin provides a small group of the most used metadata, and takes on the analyze of those present in the picture to return the most relevant information. These are called [b]Magic[/b] metadata. Thus, the [b]magic.ShotInfo.Aperture[/b] metadata returns: [ul] [li]if present in the photo, the value of the [b]exif.exif.FNumber[/b] metadata, otherwise [/li] [li]if present in the photo, the value of the [b]xmp.exif: FNumber[/b] metadata, otherwise [/li] [li]if present in the photo, the value of the [b]exif.exif.ApertureValue[/b] metadata, otherwise [/li] [li]if present in the photo, the value of the [b]xmp.exif: ApertureValue[/b] metadata.[/li] [/ul] [li][b]xmp.exif:ApertureValue[/b][/li] [li][b]xmp.exif:FNumber[/b][/li] [/ul] To facilitate the rendering of information that may be scattered, the plugin provides a small group of the most used metadata, and takes on the analyze of those present in the picture to return the most relevant information. These are called [b]Magic[/ b] metadata. Thus, the [b]magic.ShotInfo.Aperture[/b] metadata returns: [ul] [li]if present in the photo, the value of the [b]exif.exif.FNumber[/b] metadata, otherwise [/li] [li]if present in the photo, the value of the [b]xmp.exif: FNumber[/b]metadata, otherwise [/li] [li]if present in the photo, the value of the [b]exif.exif.ApertureValue[/b] metadata, otherwise [/li] [li]if present in the photo, the value of the [b]xmp.exif: ApertureValue[/b] metadata.[/li] [/ul]';
$lang['g003_y'] = "Yes";
$lang['g003_n'] = "No";
...
$lang['g003_databaseWarning1']="[p]The repository is built using the metadata contained in images from the gallery as well as metadata calculated by the plugin. Depending on the number of images and the number of metadata to be attached, the repository can be very large. <br> Before powering up the repository, make sure that the database provided by your host allows this type of use. [/p][p]It should be noted however that the use of the repository is optional, it is not used for displaying metadata for photos in the gallery. [/p][p]The filling of the repository is necessary if you wish:[/p] [ul] [li]Have statistics on the metadata in your photos (it also help in the selection of metadata)[/li] [li]Use the search engine[/li] [/ul] ";
...
$lang['g003_basic_mode_help']=" The [i]basic[/i] mode is for those who simply want to display the metadata of their photos and offers:[ul] [li]an interface as simple as possible[/li] [li]a short list of metadata (about 140, the most common)[/li] [/ul]";
$lang['g003_advanced_mode_help']="The [i]advanced[/i] mode is for those who wish to make maximum use of their photos and metadata offers:[ul] [li]an interface more complex, but complete[/li] [li]a complete list of metadata (about 540)[/li] [li]extended functionalities (statistics, search ...)[/li] [/ul] The [i]advanced[/i] mode requires to built a repository.";
$lang['g003_tags']="Tags";
...
$lang['g003_tags_page_help']="This feature performs an extraction of keywords present in the metadata for your photos and allows you to convert [i]Tags[/i]. The images for which keywords have already been converted and associates do not appear: only the keywords of images for which a conversion and a possible association are proposed.";
...
$lang['g003_personnal_page_help']="You can easily build your own metadata from existing metadata. [ul] [li]Add a new metadata[/li] [li]Fill properties[/li] [li]Add rules and combine them if necessary by drag'n'drop[/li] [/ul]";
$lang['g003_select_page_help']="Only metadata selected here are available in other interfaces configuration: this allows to reduce the list of metadata to those that seem most relevant to your use. The selection is applied immediately (it is not necessary to validate).";
$lang['g003_display_page_help']="The metadata posted with the photo can be sorted and grouped. By default, only the group [i]".$lang['g003_default_group_name']."[/i] is available, but it is possible to create as many as necessary ([i]IPTC[/i], [i]Geolocation[/i], ...). [ul] [li]Create groups of metadata according to your needs[/li] [li]Add the metadata to display[/li] [li]Within a group, sort the display order of metadata by drag'n'drop[/li] [li]Sort the display order of groups by drag'n'drop[/li] [/ul] Selection and sorting are applied immediately (it is not necessary to validate).";
$lang['g003_gpc_not_up_to_date']="It is necessary for the plugin that the <i>Grum Plugin Classes</i> version %s is installed. Currently, version %s is installed: please proceed with the update version of the plugin <i>Grum Plugin Classes</i>.";
...
$lang['g003_databaseWarning2_1']="[p]A new metadata is available since the last update of the plugin:[/p][ul]%s[/ul] [p] To be exploited, it is necessary to update the repository.[/p]";
$lang['g003_databaseWarning2_n']="[p]Some new metadatas are available since the last update of the plugin:[/p][ul]%s[/ul] [p]To be exploited, it is necessary to update the repository.[/p]";
